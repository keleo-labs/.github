...
2. Use [keleo-template](https://github.com/keleo-labs/keleo-template) to create your own practice content
3. Use [keleo-studio](https://github.com/keleo-labs/keleo-studio) to validate, visualise, and compose practices into methods
4. See [keleo-platforms](https://github.com/keleo-labs/keleo-platforms) or [keleo-horticulture](https://github.com/keleo-labs/keleo-horticulture) for real-world examples
